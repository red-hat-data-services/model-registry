...
func TestGeneratorCreateFiles(t *testing.T) {
	...
	expectedFiles := []string{
		...
		"catalog/internal/catalog/testcatalog/service/entity_mappings_test_entity.go",
		"catalog/internal/catalog/testcatalog/service/entity_mappings_test_entity_test.go",
