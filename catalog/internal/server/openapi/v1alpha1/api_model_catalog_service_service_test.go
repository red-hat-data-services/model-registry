...
func TestFindModels(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			modelList, ok := unwrapCatalogModelList(resp.Body)
...
func TestFindSources(t *testing.T) {
	...
	testCases := []struct {
		name           string
		catalogs       map[string]catalog.ModelSource
		nameFilter     string
		pageSize       string
		orderBy        model.OrderByField
		sortOrder      model.SortOrder
...
func TestGetModel(t *testing.T) {
	testCases := []struct {
		name           string
		sources        map[string]catalog.ModelSource
		sourceID       string
		modelName      string
		expectedStatus int
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			model, ok := unwrapCatalogModel(resp.Body)
...
func TestFindModelsRecommended(t *testing.T) {
	...
	require.NotNil(t, resp.Body)
	response, ok := unwrapCatalogModelList(resp.Body)
	require.True(t, ok)
...
func TestFindModelsOrderByRecommendedDesc(t *testing.T) {
	...
	require.NotNil(t, resp.Body)
	_, ok := unwrapCatalogModelList(resp.Body)
	require.True(t, ok)
