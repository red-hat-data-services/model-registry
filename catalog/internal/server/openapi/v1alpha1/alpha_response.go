...
// AlphaSkill wraps model.Skill for v1alpha1 JSON compatibility (source_id)
type AlphaSkill struct {
	model.Skill
}

func (m AlphaSkill) MarshalJSON() ([]byte, error) {
	data, err := m.Skill.MarshalJSON()
	if err != nil {
		return nil, err
	}
	return renameKeys(data, map[string]string{"sourceId": "source_id"})
...
func wrapSkill(m *model.Skill) any {
	if m == nil {
		return nil
	}
	return AlphaSkill{*m}
...
// AlphaSkillList wraps model.SkillList for v1alpha1 JSON compatibility (source_id)
type AlphaSkillList struct {
	model.SkillList
}

func (m AlphaSkillList) MarshalJSON() ([]byte, error) {
	data, err := json.Marshal(m.SkillList)
	if err != nil {
		return nil, err
	}
	return renameKeys(data, map[string]string{"sourceId": "source_id"})
...
func wrapSkillList(l *model.SkillList) any {
	if l == nil {
		return nil
	}
	return AlphaSkillList{*l}
}
