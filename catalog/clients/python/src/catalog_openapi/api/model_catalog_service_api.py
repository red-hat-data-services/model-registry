...
class ModelCatalogServiceApi:
    ...
    def find_models(
        ...
        hardware_count_property: Annotated[Optional[StrictStr], Field(description="Property name for hardware count")] = None,
        hardware_type_property: Annotated[Optional[StrictStr], Field(description="Property name for hardware type grouping")] = None,
        ...
        :type target_rps: int
        :param latency_property: Property name for latency metric
        :type latency_property: str
        :param rps_property: Property name for RPS metric
        :type rps_property: str
        :param hardware_count_property: Property name for hardware count
        :type hardware_count_property: str
        :param hardware_type_property: Property name for hardware type grouping
    ...
    def get_all_model_performance_artifacts(
        ...
        source_id: Annotated[StrictStr, Field(description="A unique identifier for a `CatalogSource`.")],
        model_name: Annotated[StrictStr, Field(description="A unique identifier for the model.")],
        target_rps: Annotated[Optional[StrictInt], Field(description="Target requests per second. If specified, values for `replicas` and `total_requests_per_second` will be calculated and returned as custom properties.")] = None,
        recommendations: Annotated[Optional[StrictBool], Field(description="Filter records that are less optimal based on approximate cost to run and latency.")] = None,
        rps_property: Annotated[Optional[StrictStr], Field(description="Custom property name for requests per second metric.")] = None,
