...
class AgentArtifactList(BaseModel):
    """
    A list of agent artifact entities.
    """ # noqa: E501
    ...
    items: List[AgentTemplateArtifact] = Field(description="Array of `AgentArtifact` entities.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentArtifactList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentArtifactList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "items": [AgentTemplateArtifact.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
