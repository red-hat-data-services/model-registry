...
class AgentImageArtifact(BaseModel):
    """
    OCI image artifact for agent deployment.
    """ # noqa: E501
    ...
    uri: StrictStr = Field(description="URI of the artifact (e.g., OCI image reference).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentImageArtifact from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentImageArtifact from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "artifactType": obj.get("artifactType") if obj.get("artifactType") is not None else 'image-artifact',
            "uri": obj.get("uri")
        })
        return _obj
