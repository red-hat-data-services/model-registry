...
class BaseResourceList(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["nextPageToken", "pageSize", "size"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate(
            {"nextPageToken": obj.get("nextPageToken"), "pageSize": obj.get("pageSize"), "size": obj.get("size")}
        )
