...
import mr_openapi.models
from mr_openapi import rest
from mr_openapi.api_response import ApiResponse
from mr_openapi.api_response import T as ApiResponseT
...
class ApiClient:
    ...
    def deserialize(self, response_text: str, response_type: str, content_type: str | None):
        ...
        if content_type is None:
            ...
            data = "" if response_text == "" else json.loads(response_text)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mr_openapi.models, klass)
